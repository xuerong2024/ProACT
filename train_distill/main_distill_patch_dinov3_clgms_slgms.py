...
def main(config, ptname='model_ema_best_auc_shanxi_val'):
    ...
    pretrained_student='/disk3/wjr/workspace/sec_proj4/baseline_expeript/selected_dcm_saomiao_900_health308_sick_592/224/contra_20250906/wmask_nosubcls_nodropout2/dinov3/vit-b/batch16_lr1e-05_testall/model_best_acc_shanxi_test.pth'
        ...
        for qq in range(len(aug_gaussian)):
            for pp in range(len(aug_rot)):
                for jj in range(len(model_name)):
                    ...
                    config.OUTPUT = os.path.join(args.output, 'wmask_nosubcls_nodropout2','model_distill_patch','dinov3stu224_trained_clgms_slgms_2teas_stutokenweight',
                                                 '224_batch10_lr' + str(args.base_lr)+'_testall')

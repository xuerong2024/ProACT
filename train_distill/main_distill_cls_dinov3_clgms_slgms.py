...
if __name__ == '__main__':
    ...
    aug_gaussian=[True]
    loss_type=['ce']
    pt_names=['model_best_acc_alltest','model_best_acc_shanxi_val','model_best_auc_shanxi_val','model_best_acc_shanxi_test','model_best_acc_guizhou_test']
        ...
        for qq in range(len(aug_gaussian)):
            for pp in range(len(aug_rot)):
                for jj in range(len(model_name)):
                    ...
                    config.OUTPUT = os.path.join(args.output, 'wmask_nosubcls_nodropout2','model_distill_cls','dinov3stu512_trained_clgms_slgms_2teas_clstoken',

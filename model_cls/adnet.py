...
'''https://github.com/Lab-LVM/ADNet/tree/main'''
...
def convnext_tiny_ADNet_IN1K_NIH(pretrained=False, in_22k=False, **kwargs):
    ...
    if pretrained:
        checkpoint = '/disk3/wjr/workspace/convnext_tiny_ADNet_IN1K_NIH.pth.tar'
...
def convnext_tiny_ADNet_ALL_NIH(pretrained=False, in_22k=False, **kwargs):
    ...
    if pretrained:
        ckp_path = '/disk3/wjr/workspace/convnext_tiny_ADNet_ALL_NIH.pth.tar'
...
def convnext_tiny_ADNet_ALL_MIMIC(pretrained=False, in_22k=False, **kwargs):
    ...
    if pretrained:
        ckp_path = '/disk3/wjr/workspace/convnext_tiny_ADNet_ALL_MIMIC.pth.tar'
        state_dict = torch.load(ckp_path, map_location="cpu")
        state_dict = state_dict['state_dict'] if 'state_dict' in state_dict else state_dict
        model.load_state_dict(state_dict)
    return model
...
def convnext_tiny_ADNet_ALL_CheXpert(pretrained=False, in_22k=False, **kwargs):
    ...
    if pretrained:
        ckp_path = '/disk3/wjr/workspace/convnext_tiny_ADNet_ALL_CheXpert.pth.tar'
        state_dict = torch.load(ckp_path, map_location="cpu")
        state_dict = state_dict['state_dict'] if 'state_dict' in state_dict else state_dict
        model.load_state_dict(state_dict)
    return model
...
if __name__ == '__main__':
    model = convnext_tiny_ADNet_IN1K_NIH(pretrained=True)

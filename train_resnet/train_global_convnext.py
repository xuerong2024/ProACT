...
def parse_option():
    ...
    parser.add_argument('--output', default='/disk3/wjr/workspace/sec_proj4/baseline_expeript_feiqu/biaozhun_book/224/contra_20251121/', type=str, metavar='PATH',

...
if __name__ == '__main__':
    d_nih = NIH_Dataset(imgpath="/disk1/wjr/dataset/NIHorg_dataset/images",
                        csvpath='/disk1/wjr/dataset/NIHorg_dataset/Data_Entry_2017.csv',
                        bbox_list_path='/disk1/wjr/dataset/NIHorg_dataset/BBox_List_2017.csv',)
    ...
    for sample in enumerate(val_loader):
        # move to gpu
        a=1
...
if __name__ == '__main__':
    ...
    dataset=Shanxi_w7masks_Subregions_5classes_Dataset('/disk3/wjr/dataset/nejm/shanxidataset/seg_rec_img_1024',
                                              '/disk3/wjr/dataset/nejm/shanxidataset/seg_rec_mask_1024',
                                              '/disk3/wjr/dataset/nejm/shanxidataset/',
                                              txtpath='/disk3/wjr/dataset/nejm/shanxidataset/stage1_health_txt/selected_dcm_saomiao_900_health308_sick_592/test.txt',
                                   ...
                                   sub_img_size=128,)
    # dataset = Shanxi_w7masks_Subregions_5classes_Dataset('/disk3/wjr/dataset/nejm/guizhoudataset/seg_rec_img_1024',

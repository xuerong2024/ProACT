...
def build_phe_loader(args):
    ...
    dataset_val = Shanxi_w7masks_5Subregions_wsubroi_Dataset(args.data_root + 'seg_rec_img_1024',
                                                            ...
                                                            txtpath=args.data_root + 'chinese_biaozhunwo_5_anchors.txt',
    ...
    for ii in range(len(radios)):
        for jj in range(len(num_prototypes)):
            for kk in range(len(FRADIOS)):
                ...
                config.OUTPUT = '/disk2/wxr/vi_feiqu_baseline/baseline_expeript/TTA/CALGM/ablation/revision/FUSION_radio/resnetnew'

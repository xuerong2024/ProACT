...
if __name__ == '__main__':
    ...
    for kk in range(len(lrs)):
        ...
        # config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CHOOSEN_200/SLGMS/ROID/'
        config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/SLGMS/ROID/epoch5'

...
def train_one_epoch(config, model, data_loader):
    ...
    for epoch in range(config.TRAIN.EPOCHS):
        model.eval()
        mem_label, imgnames = obtain_label_org(data_loader, model)
    ...
    # mem_label = obtain_label_org(data_loader, model)
    # mem_label, imgnames = obtain_isotonic_label(data_loader, model)
    return model
...
if __name__ == '__main__':
    ...
    for kk in range(len(lrs)):
        ...
        config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CHOOSEN_200/CALGM/SHOT/'
        ...
        #          f'SHOT TRAIN_FEA global_shanxi_test_avg: {shanxi_test_shot[0]}, shanxi_test_auc: {shanxi_test_shot[-1]}, shanxi_test_acc: {shanxi_test_shot[1]}, shanxi_test_sensitivity: {shanxi_test_shot[2]}, shanxi_test_specificity: {shanxi_test_shot[3]}\n' \
        #          f'SHOT TRAIN_FEA global_guizhou_test_avg: {guizhoutest_shot[0]}, guizhou_test_auc: {guizhoutest_shot[-1]}, guizhou_test_acc: {guizhoutest_shot[1]}, guizhou_test_sensitivity: {guizhoutest_shot[2]}, guizhou_test_specificity: {guizhoutest_shot[3]}\n\n'
        #
        #     file.write(re)

...
def train_one_epoch(config, model, data_loader, buffer_size=10000, sgld_steps=10, sgld_lr=1, sgld_std=0.01, reinit_freq=0.05, if_cond=False, ):
    ...
    for epoch in range(config.TRAIN.EPOCHS):
        ...
        for idx, (images, masks, targetss, img_names) in enumerate(data_loader):
            ...
            x_fake, _ = sample_q(energy_model, replay_buffer,
                                 ...
                                 batch_size=images.shape[0], im_sz=images.shape[-1], n_ch=images.shape[1], device=device, y=None)
            # 能量方案损失
...
if __name__ == '__main__':
    ...
    for kk in range(len(lrs)):
        ...
        config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CHOOSEN_200/CALGM/EFSDA/'

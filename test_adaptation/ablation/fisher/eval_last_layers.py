...
def main(config, pt_path, logger_path):
    ...
    if os.path.isfile(ckp_path):
        ...
        # ckp_path = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CALGM/ablation/para_trainable/last15_trainable/15batch_8e-05lr_15lpara_4prototypes_0.6rule_JSD/shanxi_test.pth'
        # state_dict = torch.load(ckp_path, map_location='cpu', weights_only=False)['model']
        # msg = model.load_state_dict(state_dict, strict=False)
    ...
    for ii in range(len(radios)):
        for jj in range(len(num_prototypes)):
            for kk in range(len(LOCRADIOS)):
                ...
                config.OUTPUT='/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CALGM/ablation/para_trainable/last15_trainable'

...
if __name__ == '__main__':
    ...
    for kk in range(len(lrs)):
        ...
        config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CHOOSEN_200/SLGMS/TENT/'
        ...
        with open(file_path, 'a', encoding='utf-8') as file:
            ...
            file.write(re)
# f'ORG global_all_test_acc: {avg_test_acc_org} ---> COME global_all_test_acc: {avg_test_acc_tent}\n' \

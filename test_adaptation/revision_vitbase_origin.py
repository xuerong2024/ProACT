...
def main(config, pt_path, logger_path):
    ...
    if args.model_name=='vit-base':
        # pretrained_cfg = '/disk3/wjr/workspace/sec_nejm/nejm_baseline_expeript_new/allshanxi_sick_health/writer_analyze/512/allstage1_health1_1/selected_dcm_saomiao_900_health308_sick_592/new_contra_20250626/resnet50/wmask_nosubcls_nodropout2/resnet50_lr8e-05/model_ema_best_auc_shanxi_val.pth'
        ...
        model = ViTWithFeats(pretrained_cfg=None)
    ...
    if os.path.isfile(ckp_path):
        if args.model_name == "pneullm":
            ...
            msg = model.load_state_dict(fixed_state_dict, strict=False)
        ...
        save_state = {'model': model.model.state_dict()}
    ...
    for ii in range(len(radios)):
        for jj in range(len(num_prototypes)):
            for kk in range(len(FRADIOS)):
                ...
                config.OUTPUT = '/disk2/wxr/vi_feiqu_baseline/baseline_expeript/TTA/CALGM/ablation/revision/FUSION_radio/vitbaseneworigin'
                ...
                pt_path = '/disk3/wjr/workspace/sec_nejm/nejm_baseline_expeript_new/allshanxi_sick_health/writer_analyze/512/allstage1_health1_1/selected_dcm_saomiao_900_health308_sick_592/new_contra_20250626/vit-base/wmask_nosubcls_nodropout2/vit-base_lr3e-05/model_ema_best_auc_shanxi_val.pth'

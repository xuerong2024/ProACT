...
class DPL(nn.Module):
    ...
    def __init__(self, model, feature_dim=768, num_classes=2,
        ...
        classifier_weight = self.model.classifier.head.weight
        # 初始化组件
    ...
    def loss_forward(self, x):
        ...
        # 2. 原型 = 分类器权重（论文核心设定）
        prototypes = self.model.classifier.head.weight  # [C, D]
...
if __name__ == '__main__':
    ...
    for kk in range(len(lrs)):
        ...
        config.OUTPUT = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CHOOSEN_200/SLGMS_2/DPL/'

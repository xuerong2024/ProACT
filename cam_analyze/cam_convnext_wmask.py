...
if __name__ == '__main__':
    ...
    # )
    model.to(device)
    args.output='/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/gradcam/calgm/shanxi_medtta/'
    ...
    ckpath = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CALGM/OUR/15batch_8e-05lr_15lpara_4prototypes_0.6rule_JSD/shanxi_test.pth'
    ...
    if args.data_root is None:
        ...
        for line in lines:
            ...
            for line in lines:
                ...
                if '.png' in imgname:
                    path = os.path.join(args.data_root + 'seg_rec_img_1024', imgname)
    ...
    # args.output = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/gradcam/calgm/guizhou_medtta/'
    # org_output_dir = args.output
    # # org_output_dir=os.path.join(args.output, 'ce_convnext_lr5e-05',)
    # # org_output_dir = os.path.join(args.output, '1experi_convnext_lr5e-05', )
    # # ckpath='/disk3/wjr/workspace/sec_nejm/nejm_baseline_expeript_new/allshanxi_sick_health/writer_analyze/512/allstage1_health1_1/selected_dcm_saomiao_900_health308_sick_592/new_contra_20250626/convnext/g512_l256_tree_5cls_2cls_cam_wdatamixup_3/0.5_cam_0.5_camalign_0.3_cloc_lr8e-05/model_ema_best_acc_shanxi_val.pth'
    # ckpath = '/disk3/wjr/workspace/sec_proj4/baseline_expeript/TTA/CALGM/OUR/15batch_8e-05lr_15lpara_4prototypes_0.6rule_JSD/guizhou_test.pth'
    # checkpoint = torch.load(ckpath, map_location='cpu', weights_only=False)
    # # checkpoint = torch.load(os.path.join(args.output_dir, "checkpoint_best.pth.tar"), map_location='cpu')
    # state_dict = checkpoint['model']
    # # state_dict = {k.replace("backbone.", ''): v for k, v in state_dict.items()}
    ...
    #             labelname = imgname.split('_')[0]
    #             if '.png' in imgname:
    #                 path = os.path.join('/disk3/wjr/dataset/nejm/guizhoudataset/seg_rec_img_1024', imgname)
    #                 maskpath = os.path.join('/disk3/wjr/dataset/nejm/guizhoudataset/seg_rec_mask_1024', imgname)
    #             else:
    #                 path = os.path.join('/disk3/wjr/dataset/nejm/guizhoudataset/seg_rec_img_1024', imgname + '.png')

...
if __name__ == '__main__':
    csvpath2 = "/disk3/wjr/dataset/nejm/shanxidataset/subregions_label_shanxi_all_woyinying.xlsx"
    csv2 = pd.read_excel(csvpath2)
    subregion_txtpath='/disk3/wjr/dataset/nejm/shanxidataset/stage1_health_txt/selected_dcm_saomiao_900_health308_sick_592/train_sick_biaozhun.txt'
